            ...
            link: function(scope, element, attrs, fn) {
                ...
                angular.forEach(element.find('input,select,textarea'), function(child_element) {
                    ...
                    if (!child_element.attr('name')) {
                        ...
                        console.warning('AngularValidator: One of your form elements(<input>, <textarea>, <select>) is missing a name. We got your back and added a name, but if you want a pretty one you should add it yourself.');
                ...
                if (!attrs.name) {
                    ...
                    console.warning('AngularValidator: Your form element(<form>) is missing a name. We got your back and added a name, but if you want a pretty one you should add it yourself.');
                    need_to_recompile = true;
                }
                ...
                // This is the form model on that is on the scope
                // Angular automatically adds the model to $scope with the form name, we are assigning it to a 
                // variable so its easier to access. All built-in validation states are contained on this object.
                ...
                // Watch form length to add watches for elements being added or removed.
                // This often happens with ng-if.
                ...
                element.on('submit', function(event) {
                    ...
                    // If the form is valid then call the function that is declared in the `angular-validator-submit`
                ...
                function updateValidationClass(element) {
                    ...
                    if (formField.$dirty || sscopeForm.submitted) {
